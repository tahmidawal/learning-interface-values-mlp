...
from test_subdomain_solution_v3 import InterfacePredictor, generate_test_case, extract_subdomain
...
def main():
    ...
    results_dir = 'interface_values_results_v3'
