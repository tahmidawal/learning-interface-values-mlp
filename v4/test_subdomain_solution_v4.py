...
from train_model_v4 import InterfacePredictor
...
def generate_test_case(data_gen: DataGeneratorV4, k: float):
...
def main():
    try:
        ...
        # Define k values to test (extended range)
        ...
        print("\nProcessing complete! Check the test_results_v4 directory for output plots.")
